...
document.addEventListener("click", function (f) {
  if (f.target.tagName == "path") {
      ...
      var infocontent = place.name;
        ...
        var output = "<p class=\"text-body\" class=\"tabed-text\"><br>home to " + stateData2D[stateInd][2] + " people!</p><br><p class=\"text-body\">- Female Population: " 
        ...
        + "</p><br><p class=\"text-body\" class=\"tabed-text\">- " + stateData2D[stateInd][8] + " incidents of gender-based hate crimes</p><br><p class=\"text-body\" class=\"tabed-text\">- " 
        + stateData2D[stateInd][10] + " incidents of sexual-orientation-based hate crimes</p><br><p class=\"text-body\" class=\"tabed-text\">- "
